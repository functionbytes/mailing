                            ...
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="right" valign="middle" style="padding-top:20px;padding-right:0px;" class="webv#main-wrapper[data-layout=horizontal] .sidebar-nav #sidebarnav > .sidebar-item > .sidebar-link .hide-menuiew">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="padding: 10px 20px 40px 20px;">
                                        ...
                                        <tr>
                                            <td>
                                                <p style="color:#081A28; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                    Nos complace informarte que se inscribio en el curso <strong>{{ $course }}</strong> a <strong>{{ $names }}</strong>  con identificación <strong>{{ $identification }}</strong> .
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" style="margin-top: 10px;">
                                        <tr>
                                            <td>
                                                <p style="color:#081A28; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                    El registro se realizo el  {{ $date }} .
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
