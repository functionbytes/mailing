...
@section('content')
    <form id="classic-builder-form" action="{{ route('manager.templates.update', $template->uid) }}" method="POST" class="ajax_upload_form form-validate-jqueryz builder-classic-form">
        {{ csrf_field() }}
