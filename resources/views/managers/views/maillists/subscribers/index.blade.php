                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($subscribers as $key => $item)
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="badge {{ $item->available == 1 ? 'bg-light-primary' : 'bg-light-secondary' }} rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
