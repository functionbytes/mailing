                        ...
                        <div class="btn-group btn-group-sm" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item profile-remove-contact"
                                    href="{{ route('Automation2Controller@removeContact', [
                                        'uid' => $automation->uid,
                                ...
                                <a class="dropdown-item profile-tag-contact"
                                    href="{{ route('Automation2Controller@tagContact', [
                                        'uid' => $automation->uid,
                                        'contact_uid' => $contact->uid,
                                    ]) }}"
                                >{{ trans('messages.automation.profile.manage_tag') }}</a>
                                <a class="dropdown-item" href="{{ route('SubscriberController@edit', [
            ...
            <div class="profile d-flex">
                <div class="media mr-4">
                    ...
                    @else
                        <a
                            image-popup="link"
                            href="{{ route('SubscriberController@avatarOrigin',  $contact->uid) }}"
                        >
                    ...
                    <div class="tags mt-3">
                        @if ($contact->getTags())
                            @foreach ($contact->getTags() as $tag)
                                <a href="{{ route('Automation2Controller@removeTag', [
                                    'uid' => $automation->uid,
                                    'contact_uid' => $contact->uid,
                                    'tag' => $tag,
                            ...
                            @endforeach
                        @else
                            <a href="{{ route('Automation2Controller@tagContact', [
                                        'uid' => $automation->uid,
                                        'contact_uid' => $contact->uid,
