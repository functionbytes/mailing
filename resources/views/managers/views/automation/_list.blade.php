    ...
    >
        @foreach ($automations as $key => $automation)
            <tr class="position-relative">
                ...
                <td>
                    <a class="kq_search fw-600 d-block list-title" href="{{ route('Automation2Controller@edit', $automation->uid) }}">
                        {{ $automation->name }}
                    </a>
                ...
                <td class="text-end text-nowrap pe-0">
                    @if (\Gate::allows('update', $automation))
                        <a data-popup="tooltip" href="{{ route('Automation2Controller@edit', $automation->uid) }}" role="button" class="btn btn-secondary btn-icon">
                                ...
                                @can('enable', $automation)
                                    <li>
                                        <a
                                            ...
                                            href="{{ route('Automation2Controller@enable', ["uids" => $automation->uid]) }}"
                                        >
                                ...
                                @can('disable', $automation)
                                    <li>
                                        <a
                                            ...
                                            href="{{ route('Automation2Controller@disable', ["uids" => $automation->uid]) }}"
                                        >
                                ...
                                @can('create', $automation)
                                    <li>
                                        <a
                                            list-action="copy"
                                            class="dropdown-item"
                                            href="{{ route('Automation2Controller@copy', $automation->uid) }}"
                                        >
                                ...
                                @if (\Gate::allows('delete', $automation))
                                    <li>
                                        <a
                                            ...
                                            href="{{ route('Automation2Controller@delete', ["uids" => $automation->uid]) }}"
                                        >
