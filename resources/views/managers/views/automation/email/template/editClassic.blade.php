...
@section('menu_title')
    <li class="d-flex align-items-center">
        <div class="d-inline-block d-flex mr-auto align-items-center ml-1 lvl-1">
            <h4 class="my-0 me-2 menu-title text-white">{{ $automation->name }}</h4>
...
@section('menu_right')
    ...
    <li class="nav-item d-flex align-items-center">
        <a href="{{ route('Automation2Controller@templateEditPlain', [
            'uid' => $automation->uid,
            'email_uid' => $email->uid,
        ]) }}"
...
@section('content')
    <form id="classic-builder-form" action="{{ route('Automation2Controller@templateEditClassic', [
        'uid' => $automation->uid,
        'email_uid' => $email->uid,
