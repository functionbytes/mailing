    ...
    <script>
        ...
        $( document ).ready(function() {
            editor = new Editor({
                ...
                url: '{{ route('Automation2Controller@templateContent', [
                  'uid' => $automation->uid,
                  'email_uid' => $email->uid,
                ]) }}',
                ...
                uploadAssetUrl: '{{ route('TemplateController@uploadTemplateAssets', $email->template->uid) }}',
                uploadAssetMethod: 'POST',
                saveUrl: '{{ route('Automation2Controller@templateEdit', [
                  'uid' => $automation->uid,
                  'email_uid' => $email->uid,
                ]) }}',
                saveMethod: 'POST',
