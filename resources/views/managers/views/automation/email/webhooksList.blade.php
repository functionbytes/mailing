            ...
            @foreach($email->emailWebhooks as $webhook)
                <tr>
                    ...
                    <td class="text-nowrap text-end">
                        <a href="{{ route('Automation2Controller@webhooksSampleRequest', [
                        ...
                        <a href="{{ route('Automation2Controller@webhooksTest', [
                            'webhook_uid' => $webhook->uid,
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item edit-webhook"
                                        href="{{ route('Automation2Controller@webhooksEdit', [
                                            'webhook_uid' => $webhook->uid,
                                        ]) }}">
                                ...
                                <li>
                                    <a class="dropdown-item delete-webhook"
                                        href="{{ route('Automation2Controller@webhooksDelete', [
                                            'webhook_uid' => $webhook->uid,
                                        ]) }}">
